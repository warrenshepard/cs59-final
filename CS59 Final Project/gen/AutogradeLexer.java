...
public class AutogradeLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"DIGIT", "LETTER", "SEMICOLON", "LBRACK", "RBRACK", "LPREN", "RPREN", 
			"EQUAL", "COLON", "FALSE", "TRUE", "COMMA", "DOT", "UNDERSCORE", "SLASH", 
			"NEW", "STRING", "ESC", "WS", "CONFIGURE", "POINTS", "TEST_CASES", "FUNCTION", 
	...
	public AutogradeLexer(CharStream input) {
		super(input);
